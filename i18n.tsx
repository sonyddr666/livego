...
const translations = {
  en: {
    ...
    'settings.account.apiKeySaved': 'Your API key is kept only for this browser tab and sent directly to Google when you use Gemini.',
  ...
  'pt-BR': {
    ...
    'settings.account.apiKeySaved': 'Sua chave de API fica somente nesta aba e \u00e9 enviada diretamente ao Google quando voc\u00ea usa o Gemini.',
  ...
  'es-ES': {
    ...
    'settings.account.apiKeySaved': 'Tu clave de API se conserva solo en esta pesta\u00f1a y se env\u00eda directamente a Google cuando usas Gemini.',
    'settings.account.profile': 'Perfil',
    'settings.account.plan': 'Plan',
  ...
  'fr-FR': {
    ...
    'settings.account.apiKeySaved': 'Votre cl\u00e9 API reste uniquement dans cet onglet et est envoy\u00e9e directement \u00e0 Google lorsque vous utilisez Gemini.',
